...
namespace Common
{
    public class Email
    {
        //public const string fromEmil = "280255565@qq.com";
        public const string fromEmil = "lnxmxy@163.com";
        public const string fromPass = "xy27600875";
        ...
        public static void SendEmail(string EmailTo,string EmailMessage) { 
            ...
            //如果需要认证，则用下面的方式
            smtp.Credentials = new NetworkCredential(fromEmil, fromPass);

            MailMessage mm = new MailMessage(); //实例化一个邮件类

            mm.Priority = MailPriority.High; //邮件的优先级，分为 Low, Normal, High，通常用 Normal即可

            mm.From = new MailAddress(fromEmil, "郡小二", Encoding.GetEncoding(936));
            //收件方看到的邮件来源；
            //第一个参数是发信人邮件地址
            //第二参数是发信人显示的名称
           ...
           // 注：上面的邮件来源，一定要和你登录邮箱的帐号一致，否则会认证失败
            ...
            mm.ReplyTo = new MailAddress(fromEmil, "我的接收邮箱", Encoding.GetEncoding(936));
            ...
            mm.Sender = new MailAddress(fromEmil, "郡小二", Encoding.GetEncoding(936));
